...
class PageSegueAnimation: UIStoryboardSegue, CAAnimationDelegate {
    ...
    override func perform() {
        ...
        if PageSegueAnimation.isAnimating {
            return
        }
        
        if PageSegueAnimation.stack.peek() !== destination {
            PageSegueAnimation.stack.push(vc: source)
        } else {
            _ = PageSegueAnimation.stack.pop()
            shouldUnwind = true
        }
    ...
    func animationDidStart(_ anim: CAAnimation) {
        PageSegueAnimation.isAnimating = true
    }
    
    func animationDidStop(_ anim: CAAnimation, finished flag: Bool)  {
        PageSegueAnimation.isAnimating = false
        if !shouldUnwind {
    ...
    private func scalingAnimation(destinationPath: CGPath) -> CABasicAnimation {
        ...
        animation.duration = shouldUnwind ? PageSegueAnimation.contractDur : PageSegueAnimation.expandDur
